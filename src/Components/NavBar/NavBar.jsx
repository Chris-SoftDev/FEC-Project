...
function NavBar() {
    const {profileMenuBtnRef, toggleProfileMenu, openLangMenu, isProfileMenuVisible, isLoginMenuVisible, isLangMenuVisible} = useContext(NavContext);
        ...
        <div className="nav-bar-content-container">
            ...
            <div className="nav-bar-links">
                ...
                <div className='nav-bar-lang-btn-container'>
                    <button id='nav-bar-lang-btn' onClick={openLangMenu}>
                        <svg>
