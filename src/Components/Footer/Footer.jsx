...
import FooterCurrMenu from "./FooterCurrMenu";

function Footer () {
    const { isFooterLangMenuVisible, openFooterLangMenu, isFooterCurrencyMenuVisible, openFooterCurrMenu } = useContext(NavContext)

    return ( 
        <div className="footer-content-container">
            <div className="footer-content-top-container">
                <div className="footer-column-container">
                    <div className="footer-column-header">Support</div> 
                ...
                <div className="footer-column-container">
                    ...
                    <div className="footer-column-links">
                        <ul>
                            <li><a href="#">Groundbnb.org: disaster relief housing</a></li>
                            <li><a href="#">Combating discrimination</a></li>
                        </ul>
                    </div>
                </div>
                <div className="footer-column-container">
                    <div className="footer-column-header">Hosting</div> 
                    <div className="footer-column-links">
                        <ul>
                            <li><a href="#">Groundbnb your home</a></li>
                            <li><a href="#">GroundCover for Hosts</a></li>
                            <li><a href="#">Explore hosting resources</a></li>
                            <li><a href="#">Visit our community forum</a></li>
                            <li><a href="#">How to host responsibly</a></li>
                            <li><a href="#">Groundbnb-friendly apartments</a></li>
                        </ul>
                    </div>
                </div>
                <div className="footer-column-container">
                    <div className="footer-column-header">Groundbnb</div> 
                    <div className="footer-column-links">
                        <ul>
            ...
            <div className="footer-content-bottom-container">
                <div className="footer-bottom-links-container">
                    ...
                    <ul className="legal-list">
                        <div className="legal-point-initial">·</div>
                        <a href="#" className="legal-item">Terms</a>
                        <div className="legal-point">·</div>
                        <a href="#" className="legal-item">Sitemap</a>
                        <div className="legal-point">·</div>
                        <a href="#" className="legal-item">Privacy</a>
                        <div className="legal-point">·</div>
                        <a href="#" className="legal-item">Your Privacy Choices</a>
                        <a href="#">
                ...
                <div className="footer-bottom-social-container">
                    <div className="econ-column">
                        ...
                        <div className="econ-items" id="lang-text" onClick={openFooterLangMenu}>English(US)</div>
                        <div className="econ-items" onClick={openFooterCurrMenu}>$ USD</div>
                    </div>
