            ...
            <div className='self-check-in-container'>
                    <div clasName='self-checkin-sub'>
                        ...
                        <div className='self-checkin-sub-desc'>
                            ...
                            <div className='self-check-in-description'>Check yourself in with the smartlock.</div>
                        </div>
                    ...
                    <div clasName='self-checkin-sub'>
                        <div className='key-icon'>
                            ...
                            <div className='key-description'>Great check-in experience</div>
                            <div className='key-description-second'>100% of recent guests gave the check-in rocess a 5-star rating.</div>
                    </div>    
                    ...
                    <div clasName='self-checkin-sub'>   
                        <div className='heart-icon'>
                            ...
                            <div className='heart-description'>Highly rated Host</div>
                            <div className='heart-description-second'>Tag&Sherilyn has received 5-star ratings from 95% of recent guests</div>
                    </div>
                </div> 
        {/* </div> */}
