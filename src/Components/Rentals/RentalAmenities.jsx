...
function RentalAmenities() {
    ...
    const {openAmenities, showAllAmenities, amenities, bedrooms, rulesData, safetyData} = useContext(HostContext)
        ...
        <div className='main-container'>
            <div className='content-container'>
                <div className='accom-container'>
                    ...
                    <div className="accommodations">
                        { bedrooms.bedroom_1 ? (<div className='bed-container' id='bed-1'>
                                <div id="king-bed">
                        ...
                        { bedrooms.bedroom_2 ? (<div className='bed-container' id='bed-2'>
                                <div id="queen-bed">
                                    <svg viewBox="0 0 32 32">
                        ...
                        { bedrooms.bedroom_3 ? (<div className='bed-container' id='bed-3'>
            ...
            <div className="content-container-amen" ref={amenitiesRef}>
                ...
                <div className="amen-column-cont">
                    <div className="amen-column" id='amen-column-1'>
                        { amenities.valley_view ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { amenities.kitchen ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { amenities.dedicated_workspace ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { amenities.hot_tub_or_pool ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { amenities.tv ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                            ...
                            <div className="amen-content">{amenities.tv_apps}</div>
                        </div>) : null }
                    </div>
                    <div className="amen-column" id='amen-column-2'>
                        { amenities.mountain_view ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                                <path d="M28 2a2 2 0 0 1 1.995 1.85L30 4v24a2 2 0 0 1-1.85 1.995L28 30H4a2 2 0 0 1-1.995-1.85L2 28V4a2 2 0 0 1 1.85-1.995L4 2zm-5.92 19.995L22 22H10l-.08-.005L4 27.916V28h24v-.085zM28 4H4v21.084l12-11.998 12 12zM16 15.915L11.915 20h8.17zM22 7a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2z">
                                </path>
                            </svg>
                        ...
                        { amenities.wifi ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { amenities.parking ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { rulesData.pets ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                        ...
                        { safetyData.smoke_alarm ? (<div className="amen-item">
                            <svg viewBox="0 0 32 32">
                    ...
                    { amenities.bathtub ? (<div id="amen-button-cont">
